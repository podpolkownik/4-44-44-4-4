...
export const Hero = () => {
  ...
  const smoothScroll = () => {
    const scrollDistance = window.innerHeight; // Прокрутка на один экран вниз
    ...
    const scrollStep = (timestamp: number) => {
      ...
      // Пропорционально увеличиваем прокрутку
      ...
      <div className="container mx-auto px-4 relative z-10 text-center">
        ...
        >
          ...
          <h1 className="text-5xl md:text-7xl font-bold text-white mb-6">
            Из 100 долларов в миллион: Как криптовалюта дала мне ключ к мечте
          </h1>
          <p className="text-xl md:text-2xl text-blue-100 mb-8">
            История Марка Джонсона, обычного парня, который нашёл путь к богатству в 25 лет
          </p>
          <motion.button
            onClick={smoothScroll} // Вызов функции прокрутки при клике
